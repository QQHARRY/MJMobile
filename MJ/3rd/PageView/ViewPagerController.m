...
//  ICViewPager
//
//  Created by Harry He on 08/08/2014.
//  Copyright (c) 2014 Harry He. All rights reserved.
//

#import "ViewPagerController.h"

#define kDefaultTabHeight 30 // Default tab height
#define kDefaultTabOffset 0 // Offset of the second and further tabs' from left
#define kDefaultTabWidth 65
...
#define kDefaultIndicatorColor [UIColor clearColor]
//#define kDefaultTabsViewBackgroundColor [UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1]
#define kDefaultTabsViewBackgroundColor [UIColor clearColor]
//#define kDefaultContentViewBackgroundColor [UIColor colorWithRed:255.0/255.0 green:255.0/255.0 blue:255.0/255.0 alpha:1]
#define kDefaultContentViewBackgroundColor [UIColor clearColor]

//#define TABLESELECTEDCOLOR [UIColor clearColor];
#define TABLESELECTEDCOLOR [UIColor colorWithRed:0 green:0 blue:0 alpha:0.5];
//#define TABLEUNSELECTEDCOLOR [UIColor colorWithRed:147/255.0 green:149/255.0 blue:152/255.0 alpha:1]
#define TABLEUNSELECTEDCOLOR [DesigingByCardType designingViewColorByDesign]
...
- (void)reloadData {
    ...
    _tabsView.backgroundColor = TABLESELECTEDCOLOR;
    //NSLog(@"reloadData");
    ...
    {
        [imgV  setImage:[UIImage imageNamed:@"bg_promotion_1080x1920.png"]];
    }
    else
    {
        [imgV  setImage:[UIImage imageNamed:@"bg_promotion_640x960.png"]];
    }
    //imgV.image = [UIImage imageNamed:@""];
    
    [self.view insertSubview:imgV belowSubview:_contentView];
...
- (void)pageViewController:(UIPageViewController *)pageViewController didFinishAnimating:(BOOL)finished previousViewControllers:(NSArray *)previousViewControllers transitionCompleted:(BOOL)completed {
    ...
    //int count = [previousViewControllers count];
    UIViewController *viewController = self.pageViewController.viewControllers[0];
    NSUInteger old = self.activeTabIndex;
    if ([self indexForViewController:viewController] == old)
    {
        return;
    }
    ...
    TabView* tab = [_tabs objectAtIndex:self.activeTabIndex];
    tab.backgroundColor = TABLESELECTEDCOLOR;
   // NSLog(@"UIPageViewControllerDelegate didFinishAnimating previousViewControllers");
